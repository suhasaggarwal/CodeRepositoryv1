...
public class PublisherReport2 {
		...
		private List<PublisherReport2> audience_segment_data = new ArrayList<PublisherReport2>();
		
		public List<PublisherReport2> getAudience_segment_data() {
			return audience_segment_data;
		}

		public void setAudience_segment_data(List<PublisherReport2> audience_segment_data) {
