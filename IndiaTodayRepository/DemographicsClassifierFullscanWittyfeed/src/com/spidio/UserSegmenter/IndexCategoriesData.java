...
public class IndexCategoriesData {
	...
	public static SearchHit[] searchDocumentContent1(Client client,
			String index, String type, String field, String value, String startDate,String endDate) {
		...
		SearchResponse response = client
				...
				.addSort(
						SortBuilders.fieldSort("request_time")
								.order(SortOrder.DESC)).setSize(1000000).execute()
				.actionGet();
	...
	public static void updateDocumentv1(Client client, String index, String type,
			...
			String id, String fieldgender, String fieldagegroup, String fieldincomelevel, String gender, String agegroup, String incomelevel) {
		...
		updateObject.put(fieldgender, gender);
		updateObject.put(fieldagegroup,agegroup);
		updateObject.put(fieldincomelevel, incomelevel);
		
		
        client.prepareUpdate(index, type, id)
						.setScript("ctx._source." + fieldgender + "='"+ gender + "';" + "ctx._source." + fieldagegroup + "='" + agegroup +"';"+ "ctx._source." + fieldincomelevel + "='" + incomelevel + "';",
								ScriptType.INLINE).setScriptParams(updateObject).setRetryOnConflict(5)
						.execute().actionGet();
