...
public class IndexCategoriesData2 {
	...
	public static SearchHit[] searchDocumentContent(Client client,
		...
		SearchResponse response = client
				...
				.setTypes(type)
				.setSearchType(SearchType.QUERY_AND_FETCH)
				.setFetchSource(new String[]{"authorName"}, null)
				.setQuery((QueryBuilders.matchQuery(field,value)))
				.addSort(
						SortBuilders.fieldSort("request_time")
								.order(SortOrder.DESC)).setSize(100000).execute()
				.actionGet();
	...
	public static SearchHit[] searchDocumentContentEntity(Client client,
			String index, String type, String field, String value) {
		...
		SearchResponse response = client
				...
				.setTypes(type)
				.setSearchType(SearchType.QUERY_AND_FETCH)
				.setFetchSource(new String[]{"Entity1","Entity10"}, null)
				.setQuery((QueryBuilders.matchQuery(field,value)))
				.setSize(100000).execute()
				.actionGet();
