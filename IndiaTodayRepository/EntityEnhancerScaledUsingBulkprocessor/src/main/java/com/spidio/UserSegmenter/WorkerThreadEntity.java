...
public class WorkerThreadEntity implements Callable<String> {
	...
	public WorkerThreadEntity(Client client, String refurl, String entity8, String entity10) {
		this.client = client;
		this.refurl = refurl;
	...
	public String call() {
		...
		try {
			...
			if (refurl != null && !refurl.equals("") && SpecificFieldEnhancer.refurlset.contains(refurl) == false) {
				...
				SearchHit[] results = IndexCategoriesData2.searchDocumentContentEntity(client, "entity","core2", "Entity1", refurl);

              //  System.out.println("Current url:"+ refurl);
				...
				for (SearchHit hit0 : results) {
			        ...
			        String Entity10 = (String) resultv1.get("Entity10");
					try {
					
			     //   System.out.println(entity8);
			     //   System.out.println(entity10);
			        
			        if (Entity10 == null || Entity10.isEmpty())
					IndexCategoriesData.updateDocumentEntity(client, "entity", "core2", documentId,
							"Entity8", "Entity10", entity8, entity10);
