...
public static SearchHit[] searchDocumentFingerprintIds(Client client, String index, String type,
	...
	SearchResponse response = client.prepareSearch(index)
              ...
              .setFetchSource(new String[]{"subcategory","tag","audience_segment","city","country","section","modelName","request_time","gender","agegroup","incomelevel","channel_name","referrerType","sourceUrl","engagementTime","sessionhash","date", "QuarterValue"}, null)   
