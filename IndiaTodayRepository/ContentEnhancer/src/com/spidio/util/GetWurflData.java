...
//	String ServerConnectionURL = "jdbc:mysql://192.168.101.132:3306/wurfldb";
	
	public static Connection con = DBConnector.getPooledConnection("jdbc:mysql://192.168.101.198:3306/wurfldb");
	
	
	
	public static void main(String[] args) throws IOException {
		
		String title3 = "https://fithindi.thequint.com/alt-remedies/asanas-to-aid-fertility".trim().split("\\?")[0];
   ...
   public static String get91mobilesData( String mobilesId ) {
	    ...
	    String ServerConnectionURL = "jdbc:mysql://192.168.101.198:3306/wurfldb";
		String DBUser = "root";
