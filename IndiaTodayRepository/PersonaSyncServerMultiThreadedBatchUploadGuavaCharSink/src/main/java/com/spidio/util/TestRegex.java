...
public class TestRegex {
	...
	//	days.add("2020-03-24 ");
	    ...
	    String day = dayvalue;
	    String jar = " /mnt/data//contentenhancer.jar ";
	    String jar1 = " /mnt/data//contentenhancer.jar"; 
	    String jarv1 = " /mnt/data//entityenhancer.jar ";
	    String jarv11 = " /mnt/data//entityenhancer.jar";
	    String jarv2 = " /mnt/data//etcomputeenhancer.jar ";
	    String jarv21 = " /mnt/data//etcomputeenhancer.jar";
	    String jarv3 = " /mnt/data//demographyenhancer.jar ";
	    String jarv31 = " /mnt/data//demographyenhancer.jar";
        String dateString;
