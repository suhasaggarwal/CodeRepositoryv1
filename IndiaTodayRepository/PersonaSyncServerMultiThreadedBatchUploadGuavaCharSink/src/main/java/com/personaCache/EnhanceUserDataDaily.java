...
//   System.out.println(deviceMap);
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Integer batch_size = Integer.parseInt(args[10]);
		
		EnhanceUserDataDailyv1.cachePersonas(startdate, enddate, referrerType, affinitySegments, sections, tags, channel_name, file_name, batch_file_name, batch_size);
