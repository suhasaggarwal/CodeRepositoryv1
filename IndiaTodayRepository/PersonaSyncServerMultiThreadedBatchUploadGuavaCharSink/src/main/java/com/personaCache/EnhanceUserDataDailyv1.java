...
public class EnhanceUserDataDailyv1 {
	...
	public static boolean cachePersonas(String startdate, String enddate, String referrerType, String affinitySegments,
			String sections, String tags, String channel_name, String file_name, String batch_filename,
		...
		// List<String> cookieListcron2 = mod.getCookieList(startdatecron1,
		// enddatecron1, channel_name);
		// List<String> cookieListcron3 = mod.getCookieList(startdatecron2,
		// enddatecron2, channel_name);
		// List<String> cookieListcron4 = mod.getCookieList(startdatecron3,
		// enddatecron3, channel_name);
		// List<String> cookieListcron5 = mod.getCookieList(startdatecron4,
		// enddatecron4, channel_name);
		// List<String> cookieListcron6 = mod.getCookieList(startdatecron5,
		// enddatecron5, channel_name);
		// List<String> cookieListcron7 = mod.getCookieList(startdatecron6,
		// enddatecron6, channel_name);
		// List<String> cookieListcron8 = mod.getCookieList(startdatecron7,
		// enddatecron7, channel_name);
		// List<String> cookieListcron9 = mod.getCookieList(startdatecron8,
		// enddatecron8, channel_name);
		...
		try {
			...
			for (String cookie : cookieSet) {
				...
				lst.add(new WorkerThread(client, cookie, referrerType, affinitySegments, sections, tags, writer,
						batchwriter, batch_filename, progressTracker, LastBatchCounter, Batchsize));
			}
			// System.out.println("Records:"+response1.getHits());
			List<Future<String>> maps = executor.invokeAll(lst);

		/*	
			for (Future<String> future : maps) {
				try {
					System.out.println("Tasks Executed :" + future.isDone() + "Cancel status :" + future.isCancelled()
							+ "Finish Status :" + future.isDone());
				} catch (Exception e1) {
					e1.printStackTrace();
					continue;
				}
			...
			System.out.println("Tasks Executed :" + maps.size());
         */
