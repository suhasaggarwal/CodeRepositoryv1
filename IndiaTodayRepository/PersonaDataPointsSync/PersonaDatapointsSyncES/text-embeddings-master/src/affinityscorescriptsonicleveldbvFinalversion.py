...
epDatabase = open('emotionsPersonaDatabase.txt', "r")
ecDatabase = open('emotionsCreativeDatabase.txt', "r")
dpDatabase = open('demographicPersonaDatabase.txt', "r")
dcDatabase = open('demographicCreativeDatabase.txt', "r")
...
personafname = 'personaDatabasev2.txt'
