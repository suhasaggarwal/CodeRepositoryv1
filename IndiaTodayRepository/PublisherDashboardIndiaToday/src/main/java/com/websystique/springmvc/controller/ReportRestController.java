	...
	*/
	...
	public ResponseEntity<Response> getReportqueryField(
		...
		if (articleid != null && !articleid.isEmpty()) {
			...
			String lastchar = articleid.substring(articleid.length() - 1);
			if (lastchar.equals("/")) {
		...
		if (dateRange.equals("5")){
          ...
          if (dateRange.equals("2")){
		   ...
		   if(date1.compareTo(date2)!=1)
		    	dateRange = "2020-03-24_"+dateRange1[1];
	...
	public ResponseEntity<String>  getAuthordata() {
     ...
     Integer size = module.AuthorMap.size();
	
	return new ResponseEntity<String>(output+": Map Size :"+size.toString(), HttpStatus.OK);
	...
	public ResponseEntity<String> getTagdata() {
       ...
       AggregationModule module = AggregationModule.getInstance();
	    ...
	    Integer size = module.tagMap.size();
	...
	@CrossOrigin
	@RequestMapping(value = "/report/v1/SectionData", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> getSectiondata() {
       ...
       AggregationModule module = AggregationModule.getInstance();
		...
		String output = module.getSectionMap();
	    Integer size = module.sectionMap.size();
...
/*
	...
	*/	
		...
		String siteid = "1";
	    String siteurl = "https://www.indiatoday.in/";
	    String sitename = "indiatoday";
	
	    String siteid1 = "2";
	    String siteurl1 = "https://aajtak.intoday.in/";
	    String sitename1 = "aajtak";
