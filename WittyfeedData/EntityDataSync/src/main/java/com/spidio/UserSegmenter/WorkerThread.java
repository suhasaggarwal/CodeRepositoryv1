...
import static org.elasticsearch.common.xcontent.XContentFactory.*;
	...
	public class WorkerThread implements Runnable {
	    ...
	    public WorkerThread(BulkProcessor bulkprocessor, SearchHit hit, Client client, String channel_name,  AggregationModule mod, String startate, String enddate ){
	        this.hit = hit;
	        this.client = client;
					 ...
					 // url = "http://www.shopclues.com/opus-black-cotton-formal-geometric-print-western-wear-womens-shirt.html";
				      ...
				      try {  
				        	...
				        	if(product.getEntity4()!=null && !product.getEntity4().isEmpty()){
				            	IndexCategoriesData.updateDocument(client, "enhanceduserdatabeta1", "core2", documentId, "authorName",product.getEntity4());
				        	...
				        	if(product.getEntity5()!=null && !product.getEntity5().isEmpty()){
				        		...
				        		IndexCategoriesData.updateDocument(client, "enhanceduserdatabeta1", "core2", documentId,"publishDatev1",publishdate1[0]);
