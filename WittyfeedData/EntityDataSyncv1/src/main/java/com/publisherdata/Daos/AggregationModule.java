...
public class AggregationModule
{
  ...
  public String GetEntityId(String ArticleUrl)
		    throws CsvExtractorException, Exception
		  {
		    
		    String query = "SELECT EntityId FROM entity where Entity1 Like '%"+ArticleUrl+"%'";
		    System.out.println(query);
		    CSVResult csvResult = getCsvResult(false, query);
		    List<String> headers = csvResult.getHeaders();
		    List<String> lines = csvResult.getLines();
  ...
  public Entity getProductData(String channel_name,String ArticleUrl)
	    ...
	    String query = "SELECT Entity1,Entity2,Entity3,Entity4,Entity5,Entity6,Entity8,Entity9,Entity10,Entity11,Entity12 FROM entity where Entity1 Like '%"+ArticleUrl+"%' GROUP BY Entity1,Entity2,Entity3,Entity4,Entity5,Entity6,Entity8,Entity9,Entity10,Entity11,Entity12";
	    System.out.println(query);
	    CSVResult csvResult = getCsvResult(false, query);
	    List<String> headers = csvResult.getHeaders();
	    List<String> lines = csvResult.getLines();
