...
public class ProcessDeviceData {
	...
	public static DeviceObject getDeviceDetails(String userAgent)
		...
		String brandName, model_name, marketing_name, deviceOs, device_os_version, release_date, physical_screen_width, physical_screen_height, wireless_device, tablet,browser, resolution_width, resolution_height,device_type;
	    ...
	    device_type= device.getCapability("form_factor");
		...
		obj.setDevice_type(device_type);
