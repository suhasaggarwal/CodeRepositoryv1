...
public class DeltaUrls 
{ 
    public static void main(String[] args) throws IOException
    {
        String url = "https://www.wittyfeed.com/sitemap/story-sitemap1.xml";   
        FileWriter fw = new FileWriter("wittyfeedurlfulllist.txt", true);
    	BufferedWriter bw = new BufferedWriter(fw);
    	PrintWriter writer = new PrintWriter("wittyfeedurllist.txt", "UTF-8");
    	BufferedWriter bw1 = new BufferedWriter(new FileWriter("wittyfeedurl.txt"));
    	
    	Scanner s = new Scanner(new File("wittyfeedurlfulllist.txt"));
