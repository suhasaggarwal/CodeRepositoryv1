...
public class EhCacheKeyCodeRepository3 implements KeyCodeRepository3 {
     ...
     * 
     */
	public static EhCacheKeyCodeRepository3 ehcache;
	
	public static EhCacheKeyCodeRepository3 getInstance(){
		
		if(ehcache == null)
			return new EhCacheKeyCodeRepository3();
	...
	public EhCacheKeyCodeRepository3() {
		init();
	}
     ...
     */
	@Override
	public String get(String key, boolean removeOnGet) {
		Element result =  cache.get(key);
