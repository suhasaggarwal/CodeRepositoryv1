...
````
http://172.16.105.231:9200/_plugin/sql/
````


* Simple query
````
http://172.16.105.231:9200/_sql?sql=select * from indexName limit 10
````

* Explain SQL to elasticsearch query DSL
````
http://172.16.105.231:9200/_sql/_explain?sql=select * from indexName limit 10
```` 
